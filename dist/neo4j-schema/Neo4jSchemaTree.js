...
var withSession = function withSession(driver, database, f) {
  var s;
...
var Neo4jSchemaTree = /*#__PURE__*/ (function() {
    ...
    },
    {
      ...
      value: function _populateRelationshipLinkTypes() {
        ...
        var promises = okapiIds.map(function(okapiId) {
          ...
          return withSession(_this2.driver, _this2.config.database, function(
            s
          ) {
      ...
      value: function _populate(nodeTypes, relTypes) {
        ...
        _lodash['default']
          ...
          .forEach(function(relType) {
            var id = relType;
            var entity =
              _this3.rels[id] || new _entities['default'].Neo4jRelationship(id);
