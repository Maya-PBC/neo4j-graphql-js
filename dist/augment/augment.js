...
exports.printSchemaDocument = exports.setDefaultConfig = exports.shouldAugmentRelationshipField = exports.shouldAugmentType = exports.mergeDefinitionMaps = exports.mapDefinitions = exports.augmentedSchema = exports.makeAugmentedExecutableSchema = void 0;
...
var makeAugmentedExecutableSchema = function makeAugmentedExecutableSchema(
  ...
  var typeDefs = _ref.typeDefs,
    ...
    schemaDirectives =
      _ref$schemaDirectives === void 0 ? {} : _ref$schemaDirectives,
  ...
  schemaDirectives = (0, _auth.addAuthDirectiveImplementations)(
    schemaDirectives,
    generatedTypeMap,
    config
  );
...
var augmentedSchema = function augmentedSchema(schema, config) {
  ...
  var _augmentDirectiveDefi4 = (0, _slicedToArray2['default'])(
    _augmentDirectiveDefi3,
    2
  );
...
var mapDefinitions = function mapDefinitions(_ref2) {
  ...
  var _initializeOperationT = (0, _types.initializeOperationTypes)({
    ...
    _initializeOperationT2 = (0, _slicedToArray2['default'])(
      _initializeOperationT,
      2
    ),
...
var mergeDefinitionMaps = function mergeDefinitionMaps(_ref3) {
  var _ref3$generatedTypeMa = _ref3.generatedTypeMap,
    generatedTypeMap =
      _ref3$generatedTypeMa === void 0 ? {} : _ref3$generatedTypeMa,
    _ref3$typeExtensionDe = _ref3.typeExtensionDefinitionMap,
    typeExtensionDefinitionMap =
      _ref3$typeExtensionDe === void 0 ? {} : _ref3$typeExtensionDe,
    _ref3$operationTypeMa = _ref3.operationTypeMap,
    operationTypeMap =
      _ref3$operationTypeMa === void 0 ? {} : _ref3$operationTypeMa,
    _ref3$directiveDefini = _ref3.directiveDefinitionMap,
    directiveDefinitionMap =
      _ref3$directiveDefini === void 0 ? {} : _ref3$directiveDefini,
    schemaTypeDefinition = _ref3.schemaTypeDefinition;
  var typeExtensions = (0, _values['default'])(typeExtensionDefinitionMap);

  if (typeExtensions) {
    typeExtensionDefinitionMap = typeExtensions.reduce(function(
      typeExtensions,
      extensions
    ) {
      typeExtensions.push.apply(
        typeExtensions,
        (0, _toConsumableArray2['default'])(extensions)
      );
  ...
  var definitions = (0, _values['default'])(
    _objectSpread(
      {},
      generatedTypeMap,
      {},
...
var shouldAugmentType = function shouldAugmentType(
  config,
  operationTypeName,
  typeName
) {
  return typeof config[operationTypeName] === 'boolean'
    ? config[operationTypeName] // here .exclude should be an object,
    : // set at the end of excludeIgnoredTypes
    typeName
    ? !getExcludedTypes(config, operationTypeName).some(function(excludedType) {
...
var shouldAugmentRelationshipField = function shouldAugmentRelationshipField(
  config,
  operationTypeName,
  fromName,
  toName
...
var setDefaultConfig = function setDefaultConfig(_ref4) {
  ...
  (0, _values['default'])(APIConfiguration).forEach(function(configKey) {
    if (
      !configKeys.find(function(providedKey) {
...
var extractSchemaDefinitions = function extractSchemaDefinitions(_ref6) {
  ...
  var definitions = (0, _values['default'])(
    _objectSpread({}, schema.getDirectives(), {}, schema.getTypeMap())
  ).reduce(function(astNodes, definition) {
    ...
    if (astNode) {
      ...
      if (extensionASTNodes) {
        astNodes.push.apply(
          astNodes,
          (0, _toConsumableArray2['default'])(extensionASTNodes)
        );
      }
    }
...
var getExcludedTypes = function getExcludedTypes(config, operationTypeName) {
  return config &&
    ...
    (0, _typeof2['default'])(config[operationTypeName]) === 'object' &&
