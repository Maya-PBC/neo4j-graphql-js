...
var augmentInputTypePropertyFields = function augmentInputTypePropertyFields(
  _ref
) {
  ...
  if (
    ...
    if (
      ...
      if (filteringType) {
        ...
        (_filteringType$fields = filteringType.fields).push.apply(
          _filteringType$fields,
    ...
    if (orderingType && outputType !== _spatial.SpatialType.POINT) {
      ...
      (_orderingType$values = orderingType.values).push.apply(
        _orderingType$values,
        (0, _toConsumableArray2['default'])(
...
var buildQueryOrderingArgument = function buildQueryOrderingArgument(_ref4) {
  ...
  return (0, _ast.buildInputValue)({
    ...
    type: (0, _ast.buildNamedType)({
      ...
      wrappers: (0, _defineProperty2['default'])(
        {},
...
var buildQueryFilteringInputType = function buildQueryFilteringInputType(
  _ref8
) {
  ...
  if (inputType) {
    ...
    (_inputType$fields = inputType.fields).unshift.apply(
      _inputType$fields,
      (0, _toConsumableArray2['default'])(
...
var buildLogicalFilterInputValues = function buildLogicalFilterInputValues(
  _ref9
) {
...
var buildPropertyFilters = function buildPropertyFilters(_ref10) {
  ...
  if (
    ...
    filters = buildFilters({
      ...
      filterTypes: ['not'].concat(
        (0, _toConsumableArray2['default'])(
          (0, _values['default'])(_spatial.Neo4jPointDistanceFilter)
        )
      )
    });
  } else if (
    (0, _fields.isIntegerField)({
      type: outputType
    }) ||
...
var buildFilters = function buildFilters(_ref11) {
  ...
  return filterTypes.reduce(
    function(inputValues, name) {
      ...
      var isPointDistanceFilter = (0, _values['default'])(
        _spatial.Neo4jPointDistanceFilter
      ).some(function(distanceFilter) {
      ...
      if (isListFilter) {
        ...
        fieldConfig.type.name = ''
          .concat(_types.Neo4jTypeName)
          .concat(_spatial.SpatialType.POINT, 'DistanceFilter');
      }
