...
var Neo4jPoint =
  ...
  (0, _defineProperty2['default'])(
    _Neo4jPoint,
    Neo4jPointField.LONGITUDE,
    _graphql.GraphQLFloat.name
  ),
  (0, _defineProperty2['default'])(
    _Neo4jPoint,
    Neo4jPointField.LATITUDE,
    _graphql.GraphQLFloat.name
  ),
  (0, _defineProperty2['default'])(
    _Neo4jPoint,
    Neo4jPointField.HEIGHT,
    _graphql.GraphQLFloat.name
  ),
  (0, _defineProperty2['default'])(
    _Neo4jPoint,
...
var buildSpatialDistanceFilterInputType = function buildSpatialDistanceFilterInputType(
  _ref3
) {
  ...
  if (config.spatial.point) {
    var typeName = ''
      ...
      .concat(SpatialType.POINT, 'DistanceFilter'); // Overwrite
      ...
      fields: [
        (0, _ast.buildInputValue)({
          ...
          type: (0, _ast.buildNamedType)({
            name: ''
              .concat(_types.Neo4jTypeName)
              .concat(SpatialType.POINT, 'Input'),
