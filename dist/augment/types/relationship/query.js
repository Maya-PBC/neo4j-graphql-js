 ...
 */
var RelationshipQueryArgument = _objectSpread(
  {},
  _inputValues.FilteringArgument
);
/**
...
var augmentRelationshipQueryAPI = function augmentRelationshipQueryAPI(_ref) {
  ...
  if (
    (0, _augment.shouldAugmentRelationshipField)(
      config,
      queryTypeNameLower,
      fromType,
      toType
    ...
    if (
      ...
      var _transformRelationshi2 = (0, _slicedToArray2['default'])(
        _transformRelationshi,
        2
      );
...
var augmentRelationshipTypeFieldInput = function augmentRelationshipTypeFieldInput(
  _ref2
) {
  var typeName = _ref2.typeName,
    ...
    config = _ref2.config;
  var nodeFilteringFields =
    nodeInputTypeMap[_inputValues.FilteringArgument.FILTER].fields;
  var relationshipFilterTypeName = '_'
    .concat(typeName)
    .concat(outputType[0].toUpperCase() + outputType.substr(1)); // Assume outgoing relationship

  if (fromType === toType) {
    relationshipFilterTypeName = '_'.concat(outputType, 'Directions');
  }

  nodeFilteringFields.push.apply(
    nodeFilteringFields,
  ...
  var _augmentRelationshipT4 = (0, _slicedToArray2['default'])(
    _augmentRelationshipT3,
    2
  );
...
var augmentRelationshipTypeFieldArguments = function augmentRelationshipTypeFieldArguments(
  _ref3
) {
...
var transformRelationshipTypeFieldOutput = function transformRelationshipTypeFieldOutput(
  _ref4
) {
  ...
  var relationshipOutputName = '_'
    .concat(typeName)
    .concat(fieldName[0].toUpperCase() + fieldName.substr(1));
...
var buildRelationshipFieldOutputTypes = function buildRelationshipFieldOutputTypes(
  _ref7
) {
    ...
    generatedTypeMap[reflexiveOutputName] = (0, _ast.buildObjectType)({
      ...
      fields: buildNodeOutputFields({
        ...
        wrappers: (0, _defineProperty3['default'])(
          {},
          _fields.TypeWrappers.LIST_TYPE,
          true
        )
      }),
  ...
  generatedTypeMap[relationshipOutputName] = (0, _ast.buildObjectType)({
    ...
    fields: [].concat(
      (0, _toConsumableArray2['default'])(propertyOutputFields),
      [
        (0, _ast.buildField)({
          name: (0, _ast.buildName)({
            name: relatedType
...
var buildRelationshipSelectionArgumentInputTypes = function buildRelationshipSelectionArgumentInputTypes(
  _ref8
) {
  ...
  var relationshipFilteringFields =
    relationshipInputTypeMap[_inputValues.FilteringArgument.FILTER].fields;
  var relatedTypeFilterName =
    relationshipInputTypeMap[_inputValues.FilteringArgument.FILTER].name;

  if (fromType === toType) {
    var reflexiveFilteringTypeName = ''.concat(
      relationshipFilterTypeName,
      'Filter'
    );
    generatedTypeMap[reflexiveFilteringTypeName] = (0,
    _ast.buildInputObjectType)({
      name: (0, _ast.buildName)({
...
var validateRelationTypeDirectedFields = function validateRelationTypeDirectedFields(
  ...
  if (fromName !== toName && toName !== typeName && fromName !== typeName) {
    throw new Error(
      'The '
        .concat(fieldName, ' field on the ')
        .concat(typeName, ' node type uses the ')
        .concat(outputType, ' relationship type but ')
        .concat(outputType, ' comes from ')
