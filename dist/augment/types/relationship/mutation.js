...
var augmentRelationshipMutationAPI = function augmentRelationshipMutationAPI(
  _ref
) {
  var typeName = _ref.typeName,
    ...
    propertyInputValues =
      _ref$propertyInputVal === void 0 ? [] : _ref$propertyInputVal,
    _ref$propertyOutputFi = _ref.propertyOutputFields,
    propertyOutputFields =
      _ref$propertyOutputFi === void 0 ? [] : _ref$propertyOutputFi,
  ...
  if (
    ...
    (0, _values['default'])(RelationshipMutation).forEach(function(
      mutationAction
    ) {
      ...
      if (
        ...
        var _buildRelationshipMut2 = (0, _slicedToArray2['default'])(
          _buildRelationshipMut,
          2
        );
...
var buildRelationshipMutationAPI = function buildRelationshipMutationAPI(
  _ref3
) {
...
var buildRelationshipMutationField = function buildRelationshipMutationField(
  _ref4
) {
  ...
  if (
    ...
    operationTypeMap[_types.OperationType.MUTATION].fields.push(
      (0, _ast.buildField)({
        name: (0, _ast.buildName)({
          name: mutationName
        }),
...
var buildRelationshipPropertyInputArgument = function buildRelationshipPropertyInputArgument(
  _ref5
) {
...
var buildRelationshipMutationPropertyInputType = function buildRelationshipMutationPropertyInputType(
  _ref6
) {
  ...
  if (
    ...
    var nonComputedPropertyInputFields = propertyInputValues.filter(function(
      field
    ) {
...
var buildRelationshipMutationArguments = function buildRelationshipMutationArguments(
  _ref7
) {
...
var buildRelationshipMutationDirectives = function buildRelationshipMutationDirectives(
  _ref8
) {
  ...
  if (
    (0, _directives.useAuthDirective)(
      config,
      _directives.DirectiveDefinition.HAS_SCOPE
    )
  ) {
    var authAction = '';
    ...
    if (authAction) {
      directives.push(
        (0, _directives.buildAuthScopeDirective)({
          scopes: [
            {
              typeName: fromType,
              mutation: authAction
...
var buildRelationshipMutationOutputType = function buildRelationshipMutationOutputType(
  _ref9
) {
  ...
  if (
    ...
    if (
      ...
      fields.push.apply(
        fields,
        (0, _toConsumableArray2['default'])(mutationOutputFields)
      );
    } // Overwrite
...
var buildRelationshipMutationName = function buildRelationshipMutationName(
  _ref10
) {
