...
var augmentRelationshipTypeField = function augmentRelationshipTypeField(_ref) {
  ...
  if (
    !(0, _types.isOperationTypeDefinition)({
    ...
    if (
      ...
      var _augmentRelationshipT = augmentRelationshipTypeFields({
        ...
        _augmentRelationshipT2 = (0, _slicedToArray2['default'])(
      ...
      var _augmentRelationshipQ2 = (0, _slicedToArray2['default'])(
        _augmentRelationshipQ,
        5
      );
...
var augmentRelationshipTypeFields = function augmentRelationshipTypeFields(
  _ref2
) {
  ...
  var relationshipInputTypeMap = (0, _defineProperty2['default'])(
    {},
    _inputValues.FilteringArgument.FILTER,
    {
  ...
  var propertyOutputFields = fields.reduce(function(outputFields, field) {
    ...
    if (
      ...
      if (
        ...
        relationshipInputTypeMap = (0,
        _inputValues.augmentInputTypePropertyFields)({
...
var decideDefaultRelationshipName = function decideDefaultRelationshipName(
  _ref3
) {
