...
var isStringField = function isStringField(_ref5) {
  var kind = _ref5.kind,
    type = _ref5.type;
  return (
    _types.Neo4jDataType.PROPERTY[kind] === 'String' ||
    _types.Neo4jDataType.PROPERTY[type] === 'String'
  );
};
...
var isNonNullNamedTypeField = function isNonNullNamedTypeField(_ref12) {
...
var isListTypeField = function isListTypeField(_ref13) {
...
var isNonNullListTypeField = function isNonNullListTypeField(_ref14) {
  var _ref14$wrappers = _ref14.wrappers,
    wrappers = _ref14$wrappers === void 0 ? {} : _ref14$wrappers;
...
var unwrapNamedType = function unwrapNamedType(_ref15) {
  var _unwrappedType$wrappe;

  var _ref15$type = _ref15.type,
    type = _ref15$type === void 0 ? {} : _ref15$type,
    _ref15$unwrappedType = _ref15.unwrappedType,
    unwrappedType = _ref15$unwrappedType === void 0 ? {} : _ref15$unwrappedType;
  // Initialize wrappers for this type
  unwrappedType.wrappers =
    ((_unwrappedType$wrappe = {}),
    (0, _defineProperty2['default'])(
      _unwrappedType$wrappe,
      TypeWrappers.LIST_TYPE,
      false
    ),
    (0, _defineProperty2['default'])(
      _unwrappedType$wrappe,
    ...
    (0, _defineProperty2['default'])(
      _unwrappedType$wrappe,
      TypeWrappers.NON_NULL_LIST_TYPE,
      false
    ),
    _unwrappedType$wrappe); // Get wrapped type
...
var getFieldDefinition = function getFieldDefinition(_ref16) {
...
var getTypeExtensionFieldDefinition = function getTypeExtensionFieldDefinition(
  _ref17
) {
  var _ref17$typeExtensions = _ref17.typeExtensions,
    typeExtensions =
      _ref17$typeExtensions === void 0 ? [] : _ref17$typeExtensions,
...
var getFieldType = function getFieldType(_ref18) {
  var _ref18$fields = _ref18.fields,
    fields = _ref18$fields === void 0 ? [] : _ref18$fields,
...
var buildNeo4jSystemIDField = function buildNeo4jSystemIDField(_ref19) {
  var typeName = _ref19.typeName,
    propertyOutputFields = _ref19.propertyOutputFields,
    nodeInputTypeMap = _ref19.nodeInputTypeMap,
  ...
  if ((0, _augment.shouldAugmentType)(config, queryTypeNameLower, typeName)) {
    ...
    var orderingValues =
      nodeInputTypeMap[_inputValues.OrderingArgument.ORDER_BY].values;
    var systemIDOrderingValue = orderingValues.find(function(value) {
      return (
        value.name.value === ''.concat(Neo4jSystemIDField, '_asc') ||
        value.name.value === ''.concat(Neo4jSystemIDField, '_desc')
      );
    });
    ...
    if (!systemIDOrderingValue) {
      ...
      (_nodeInputTypeMap$Ord =
        ...
        (0, _toConsumableArray2['default'])(
          (0, _inputValues.buildPropertyOrderingValues)({
...
var propertyFieldExists = function propertyFieldExists(_ref20) {
  var _ref20$definition = _ref20.definition,
    definition = _ref20$definition === void 0 ? {} : _ref20$definition,
    _ref20$typeDefinition = _ref20.typeDefinitionMap,
    typeDefinitionMap =
      _ref20$typeDefinition === void 0 ? {} : _ref20$typeDefinition;
